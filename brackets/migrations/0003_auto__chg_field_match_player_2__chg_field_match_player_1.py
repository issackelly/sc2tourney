...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Match.player_2'
        db.alter_column('brackets_match', 'player_2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['brackets.Player']))

        # Changing field 'Match.player_1'
        db.alter_column('brackets_match', 'player_1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['brackets.Player']))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Match.player_2'
        raise RuntimeError("Cannot reverse this migration. 'Match.player_2' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Match.player_1'
        raise RuntimeError("Cannot reverse this migration. 'Match.player_1' and its values cannot be restored.")
    models = {
        'auth.group': {
