...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('sc2match_map', 'gateway')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Map.maphash'
        raise RuntimeError("Cannot reverse this migration. 'Map.maphash' and its values cannot be restored.")
        # Adding field 'Map.gateway'
        db.add_column('sc2match_map', 'gateway',
