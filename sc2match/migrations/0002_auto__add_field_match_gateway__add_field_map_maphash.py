...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.gateway'
        db.add_column('sc2match_match', 'gateway',
                      self.gf('django.db.models.fields.CharField')(default='us', max_length=32),
                      keep_default=False)

        # Adding field 'Map.maphash'
        db.add_column('sc2match_map', 'maphash',
                      self.gf('django.db.models.fields.CharField')(default='junk', unique=True, max_length=256),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Match.gateway'
        db.delete_column('sc2match_match', 'gateway')

        # Deleting field 'Map.maphash'
        db.delete_column('sc2match_map', 'maphash')
    ...
    models = {
        ...
        'sc2match.map': {
            ...
            'maphash': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'}),
        ...
        'sc2match.playerresult': {
            ...
            'player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'matches'", 'to': "orm['profiles.Player']"}),
